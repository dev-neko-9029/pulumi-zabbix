...
export class ItemSimple extends pulumi.CustomResource {
    /**
     * Get an existing ItemSimple resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ItemSimpleState, opts?: pulumi.CustomResourceOptions): ItemSimple {
        return new ItemSimple(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zabbix:index/itemSimple:ItemSimple';

    /**
     * Returns true if the given object is an instance of ItemSimple.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ItemSimple {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ItemSimple.__pulumiType;
    }
    ...
    public readonly preprocessors!: pulumi.Output<outputs.ItemSimplePreprocessor[] | undefined>;
    public readonly tags!: pulumi.Output<outputs.ItemSimpleTag[] | undefined>;
    /**
     * Item Trends
     */
    ...
    /**
     * Create a ItemSimple resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ItemSimpleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ItemSimpleArgs | ItemSimpleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ItemSimpleState | undefined;
            ...
            const args = argsOrState as ItemSimpleArgs | undefined;
        ...
        super(ItemSimple.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ItemSimple resources.
 */
export interface ItemSimpleState {
    /**
     * Application IDs to associate this item with
     */
    ...
    preprocessors?: pulumi.Input<pulumi.Input<inputs.ItemSimplePreprocessor>[]>;
    tags?: pulumi.Input<pulumi.Input<inputs.ItemSimpleTag>[]>;
    /**
     * Item Trends
     */
...
/**
 * The set of arguments for constructing a ItemSimple resource.
 */
export interface ItemSimpleArgs {
    /**
     * Application IDs to associate this item with
     */
    applications?: pulumi.Input<pulumi.Input<string>[]>;
