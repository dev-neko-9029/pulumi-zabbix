...
export class ProtoGraph extends pulumi.CustomResource {
    /**
     * Get an existing ProtoGraph resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProtoGraphState, opts?: pulumi.CustomResourceOptions): ProtoGraph {
        return new ProtoGraph(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zabbix:index/protoGraph:ProtoGraph';

    /**
     * Returns true if the given object is an instance of ProtoGraph.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProtoGraph {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProtoGraph.__pulumiType;
    }
    ...
    public readonly items!: pulumi.Output<outputs.ProtoGraphItem[]>;
    /**
     * Show legend
     */
    ...
    /**
     * Create a ProtoGraph resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ProtoGraphArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ProtoGraphArgs | ProtoGraphState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProtoGraphState | undefined;
            ...
            const args = argsOrState as ProtoGraphArgs | undefined;
        ...
        super(ProtoGraph.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ProtoGraph resources.
 */
export interface ProtoGraphState {
    /**
     * Show 3d graph
     */
    ...
    items?: pulumi.Input<pulumi.Input<inputs.ProtoGraphItem>[]>;
    /**
     * Show legend
     */
...
/**
 * The set of arguments for constructing a ProtoGraph resource.
 */
export interface ProtoGraphArgs {
    /**
     * Show 3d graph
     */
    do3d?: pulumi.Input<boolean>;
