...
export class ProtoItemHttp extends pulumi.CustomResource {
    /**
     * Get an existing ProtoItemHttp resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProtoItemHttpState, opts?: pulumi.CustomResourceOptions): ProtoItemHttp {
        return new ProtoItemHttp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zabbix:index/protoItemHttp:ProtoItemHttp';

    /**
     * Returns true if the given object is an instance of ProtoItemHttp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProtoItemHttp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProtoItemHttp.__pulumiType;
    }
    ...
    public readonly preprocessors!: pulumi.Output<outputs.ProtoItemHttpPreprocessor[] | undefined>;
    /**
    ...
    public readonly tags!: pulumi.Output<outputs.ProtoItemHttpTag[] | undefined>;
    /**
    ...
    /**
     * Create a ProtoItemHttp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ProtoItemHttpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ProtoItemHttpArgs | ProtoItemHttpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProtoItemHttpState | undefined;
            ...
            const args = argsOrState as ProtoItemHttpArgs | undefined;
        ...
        super(ProtoItemHttp.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ProtoItemHttp resources.
 */
export interface ProtoItemHttpState {
    /**
     * Application IDs to associate this item with
     */
    ...
    preprocessors?: pulumi.Input<pulumi.Input<inputs.ProtoItemHttpPreprocessor>[]>;
    /**
     * HTTP proxy connection string
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.ProtoItemHttpTag>[]>;
    /**
     * http request timeout
     */
...
/**
 * The set of arguments for constructing a ProtoItemHttp resource.
 */
export interface ProtoItemHttpArgs {
    /**
     * Application IDs to associate this item with
     */
    applications?: pulumi.Input<pulumi.Input<string>[]>;
