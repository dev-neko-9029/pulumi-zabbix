...
export class ItemAgent extends pulumi.CustomResource {
    /**
     * Get an existing ItemAgent resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ItemAgentState, opts?: pulumi.CustomResourceOptions): ItemAgent {
        return new ItemAgent(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zabbix:index/itemAgent:ItemAgent';

    /**
     * Returns true if the given object is an instance of ItemAgent.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ItemAgent {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ItemAgent.__pulumiType;
    }
    ...
    public readonly preprocessors!: pulumi.Output<outputs.ItemAgentPreprocessor[] | undefined>;
    public readonly tags!: pulumi.Output<outputs.ItemAgentTag[] | undefined>;
    /**
     * Item Trends
     */
    ...
    /**
     * Create a ItemAgent resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ItemAgentArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ItemAgentArgs | ItemAgentState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ItemAgentState | undefined;
            ...
            const args = argsOrState as ItemAgentArgs | undefined;
        ...
        super(ItemAgent.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ItemAgent resources.
 */
export interface ItemAgentState {
    /**
     * Active zabbix agent Item
     */
    ...
    preprocessors?: pulumi.Input<pulumi.Input<inputs.ItemAgentPreprocessor>[]>;
    tags?: pulumi.Input<pulumi.Input<inputs.ItemAgentTag>[]>;
    /**
     * Item Trends
     */
...
/**
 * The set of arguments for constructing a ItemAgent resource.
 */
export interface ItemAgentArgs {
    /**
     * Active zabbix agent Item
     */
    active?: pulumi.Input<boolean>;
