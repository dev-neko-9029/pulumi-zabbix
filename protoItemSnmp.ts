...
export class ProtoItemSnmp extends pulumi.CustomResource {
    /**
     * Get an existing ProtoItemSnmp resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProtoItemSnmpState, opts?: pulumi.CustomResourceOptions): ProtoItemSnmp {
        return new ProtoItemSnmp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zabbix:index/protoItemSnmp:ProtoItemSnmp';

    /**
     * Returns true if the given object is an instance of ProtoItemSnmp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProtoItemSnmp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProtoItemSnmp.__pulumiType;
    }
    ...
    public readonly preprocessors!: pulumi.Output<outputs.ProtoItemSnmpPreprocessor[] | undefined>;
    /**
     * LLD Rule ID
     */
    ...
    public readonly tags!: pulumi.Output<outputs.ProtoItemSnmpTag[] | undefined>;
    /**
     * Item Trends
     */
    ...
    /**
     * Create a ProtoItemSnmp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ProtoItemSnmpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ProtoItemSnmpArgs | ProtoItemSnmpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProtoItemSnmpState | undefined;
            ...
            const args = argsOrState as ProtoItemSnmpArgs | undefined;
        ...
        super(ProtoItemSnmp.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ProtoItemSnmp resources.
 */
export interface ProtoItemSnmpState {
    /**
     * Application IDs to associate this item with
     */
    ...
    preprocessors?: pulumi.Input<pulumi.Input<inputs.ProtoItemSnmpPreprocessor>[]>;
    /**
     * LLD Rule ID
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.ProtoItemSnmpTag>[]>;
    /**
     * Item Trends
     */
...
/**
 * The set of arguments for constructing a ProtoItemSnmp resource.
 */
export interface ProtoItemSnmpArgs {
    /**
     * Application IDs to associate this item with
     */
    applications?: pulumi.Input<pulumi.Input<string>[]>;
