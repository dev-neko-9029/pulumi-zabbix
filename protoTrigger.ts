...
export class ProtoTrigger extends pulumi.CustomResource {
    /**
     * Get an existing ProtoTrigger resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProtoTriggerState, opts?: pulumi.CustomResourceOptions): ProtoTrigger {
        return new ProtoTrigger(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zabbix:index/protoTrigger:ProtoTrigger';

    /**
     * Returns true if the given object is an instance of ProtoTrigger.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProtoTrigger {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProtoTrigger.__pulumiType;
    }
    ...
    public readonly tags!: pulumi.Output<outputs.ProtoTriggerTag[] | undefined>;
    /**
    ...
    /**
     * Create a ProtoTrigger resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ProtoTriggerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ProtoTriggerArgs | ProtoTriggerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProtoTriggerState | undefined;
            ...
            const args = argsOrState as ProtoTriggerArgs | undefined;
        ...
        super(ProtoTrigger.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ProtoTrigger resources.
 */
export interface ProtoTriggerState {
    /**
     * Trigger comments
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.ProtoTriggerTag>[]>;
    /**
     * link to url relevent to trigger
     */
...
/**
 * The set of arguments for constructing a ProtoTrigger resource.
 */
export interface ProtoTriggerArgs {
    /**
     * Trigger comments
     */
    comments?: pulumi.Input<string>;
